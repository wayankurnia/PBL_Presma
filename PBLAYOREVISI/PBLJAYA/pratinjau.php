...
<body>
    <div class="sidebar">
        ...
        <p>SuperAdmin</p>
        <a class="btn btn-primary" onclick="window.location.href='dashboardSuperadmin.php';">Dashboard</a>
    ...
    <div class="container">
        <main class="content">
           ...
           <!-- Tombol Verifikasi, Tolak, dan Kembali -->
            <div class="action-buttons">
                ...
                <button type="button" class="btn-back" onclick="window.location.href='dashboardSuperadmin.php';">Kembali</button>
                </div>
