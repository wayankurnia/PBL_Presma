...
class Admin {
    ...
    public function searchPrestasi($tingkatLomba = '', $programStudi = '') {
        $query = "SELECT * FROM prestasi WHERE status = 'verified'";
        $params = [];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $searchResults = $admin->searchPrestasi($tingkatLomba, $programStudi);
}
?>
...
<body>
    <div class="sidebar">
        ...
        <a href="prestasi.php" class="menu-link">Tambah Prestasi Mahasiswa</a>
